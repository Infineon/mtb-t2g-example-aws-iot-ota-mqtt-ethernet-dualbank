...
/* Set the static IP address, gateway and subnet mask address of the client */
#define STATIC_IP_ADDR                    MAKE_IPV4_ADDRESS( 192, 168, 1, 30 )
#define STATIC_GATEWAY                    MAKE_IPV4_ADDRESS( 192, 168, 1, 1 )
#define NETMASK                           MAKE_IPV4_ADDRESS( 255, 255, 255, 0 )
#define DNS_SERVER                        MAKE_IPV4_ADDRESS( 192, 168, 1, 1 )
#endif
